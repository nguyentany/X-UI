#!/usr/bin/bash
echo " ☢☢☢☢☢☢ NGUYỄN TẤN Ý Thiết Kế Tool ☢☢☢☢☢☢ "
echo " "
...
echo " ✡✡✡✡✡✡✡✡✡✡✡✡✡✡✡✡✡✡✡✡✡✡✡✡✡✡✡✡✡✡ "
echo " "
echo " ☯☯☯☯☯☯ Gọi Cho Tấn Ý Giá VPS Hợp Lý: 0388322426  ☯☯☯☯☯☯ "
...
then
        ...
        echo " Tiến Hành ... "
        apt-get update -y
        bash <(curl -Ls https://raw.githubusercontent.com/nguyentany/X-UI/master/caidatxui.sh)
        ufw allow 54321
        ufw allow 443
        ufw allow 80
        ufw allow 80/tcp
...
then
        ...
        bash <(curl -Ls https://raw.githubusercontent.com/nguyentany/X-UI/master/bbr.sh)
        bash menucaidat.sh
elif [ $so -eq 4 ]
then
        clear
...
then         
        ...
        echo " "
        echo " ☸☸☸Nếu Muốn Gọi Tôi Hãy Dùng Lệnh Như Ban Đầu Là : bash <(curl -Ls bash <(curl -Ls https://raw.githubusercontent.com/nguyentany/X-UI/master/menutany.sh))☸☸☸ "
        echo " "
        echo " ✠✠✠ Vào Nhóm Chúng Tôi Giao Lưu https://www.facebook.com/nguyentany.2105 ✠✠✠ "
